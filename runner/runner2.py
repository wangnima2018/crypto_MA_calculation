...
class CryptoUtil(object):
    ...
    def send_email_to_user(self):
        if self.send_email:
            ...
            sender_email = "wupeng2020cryptoalert@gmail.com"  # Enter your address
            receiver_email = "wupeng2020cryptoalert@gmail.com"  # Enter receiver address
            email_password = "wangnima2018"
